...
const Match = ({match}) => {
  ...
  const team1 = T1[0]
  const team2 = T2[0]
  return<Box sx={{my: 2,  width: '100%', mx: 'auto', maxWidth: '700px', display: 'flex', flexDirection: 'row', borderLeftColor: 'grey', borderLeftWidth: 2, borderLeftStyle: 'solid' }}>

    <Typography sx={{color: 'text.disabled', fontSize: 15, fontFamily: 'Signika', textAlign: 'center', mx:2, alignSelf: 'center'}}>
      {Eps}
    </Typography>
